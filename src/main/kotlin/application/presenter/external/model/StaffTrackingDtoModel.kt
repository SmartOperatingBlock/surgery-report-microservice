...
/**
 * Module that wraps all the api model of staff tracking service.
 */
object StaffTrackingDtoModel {
    /**
     * It represents the result returned by external staff tracking system, and it models tracking information of a
     * health professional. The information returned are: [dateTime], [roomId], [healthProfessionalId]
     * and [trackingType].
     */
    @Serializable
